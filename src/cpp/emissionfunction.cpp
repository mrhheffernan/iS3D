...
EmissionFunctionArray::EmissionFunctionArray(ParameterReader* paraRdr_in, Table* chosen_particles_in, Table* pT_tab_in,
  ...
  int get_charge(int pid) {
    ...
    // Mesons and Baryons
      ...
      int neg_baryon_array[] = {1112, 1114, 1116, 1118, 3112, 3114, 
        3116, 3118, 3312, 3314, 3334, 5112, 5114, 5132, 5312, 5314, 
        5332, 5334, 5512, 5514, 5532, 5534, 5554, 11112, 11114, 11116,
        13112, 13114, 13116, 13314, 21112, 21114, 23112, 23114, 103316, 
        203312, 203316, 203338, 9903118};

        //{1114, 1118, 11116, 13114, 21112, 23114, 3112, 
        ...
        //5312, 5314, 5332, 5334, 5512, 5514, 5532, 5534, 5554, 11112};
